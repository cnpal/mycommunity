...
//            回复问题
    ...
    private void createNotify(Comment comment, Long receiever, String notifierName, String outerTitle, NotificationTypeEnum notificationType, Long outId) {
        ...
        notification.setReceiver(receiever);
